...
import { Muxer, ArrayBufferTarget } from './mp4-muxer.mjs?v=20260910q';
...
window.MP4Export = {
  ...
  // Shared with the gameplay exporter (same muxer build, same codec probing).
  lib: { Muxer, ArrayBufferTarget, pickCodec },
